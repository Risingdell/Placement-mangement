...
import { MdAdd, MdGroup, MdEmail, MdEdit, MdDelete, MdClose, MdSearch, MdCheckBox, MdCheckBoxOutlineBlank } from 'react-icons/md';
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center justify-end gap-0.5">
                          <button
                            ...
                            className="p-2 text-violet-500 hover:bg-violet-50/50 transition-colors"
                          ...
                          <button
                            ...
                            className="p-2 text-emerald-500 hover:bg-emerald-50/50 transition-colors"
                            title="Send Message"
                          >
                            <MdEmail size={22} />
                          </button>
                          <button
                            ...
                            className="p-2 text-indigo-500 hover:bg-indigo-50/50 transition-colors"
                            title="Edit"
                          >
                            <MdEdit size={22} />
                          </button>
                          <button
                            ...
                            className="p-2 text-red-500 hover:bg-red-50/50 transition-colors"
                            title="Delete"
                          >
                            <MdDelete size={22} />
                          </button>
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-2 sm:p-4">
          ...
          <div className={`relative ${modalBg} shadow-2xl w-full max-w-6xl flex flex-col z-10 max-h-[98vh]`}>
            ...
            <div className={`flex items-center justify-between px-4 sm:px-6 py-4 sm:py-5 border-b ${divider} flex-shrink-0`}>
              ...
              <button
                onClick={() => !saving && setShowModal(false)}
                className={`p-1.5 ${sub} hover:opacity-70 transition-opacity`}
              >
                <MdClose size={22} />
              </button>
            </div>
