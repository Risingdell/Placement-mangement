...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#e8e8e8]">
      ...
      {/* ── Navbar ── */}
      <header className="w-full bg-[#e8e8e8] border-b-2 border-[#323232]">
        <div className="flex items-center justify-between px-4 py-2 max-w-screen-xl mx-auto">
          ...
          <img
            ...
            className="h-10 w-auto sm:h-12 md:h-14 object-contain bg-white border-2 border-[#323232] shadow-[4px_4px_0px_#323232] rounded p-1"
          />

          {/* Center: college name */}
          <div className="flex-1 text-center px-2">
            <span className="text-black font-bold tracking-widest uppercase text-xs sm:text-sm md:text-base lg:text-lg leading-tight">
      ...
      <main className="flex-1 flex flex-col items-center justify-center py-10 px-4">
        ...
        <div className="flex flex-wrap justify-center gap-8 sm:gap-12 max-w-5xl w-full">
          ...
          <div className="neo-card">
            ...
            <div className="w-20 h-20 bg-white border-2 border-[#323232] shadow-[3px_3px_0px_#323232] rounded flex items-center justify-center">
            ...
            <button onClick={() => navigate('/login')} className="neo-button">
          ...
          <div className="neo-card">
            ...
            <button onClick={() => navigate('/admin/login')} className="neo-button">
              <svg className="neo-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
              Continue as Admin
