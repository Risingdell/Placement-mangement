...
function ProfileRightSidebar({ profile, readiness }) {
  ...
  return (
    <div className="space-y-6">
      <div className="bg-[#1d1d22] rounded-2xl border border-[#2f2f36] p-5 shadow-[0_8px_24px_rgba(0,0,0,0.25)]">
        ...
        <div className="mb-4">
          ...
          <div className="h-2 rounded-full bg-[#2a2a31] overflow-hidden">
            <div
        ...
        <button
          ...
          className="w-full py-2.5 bg-[#24242b] text-[#f7b545] text-sm font-medium rounded-lg hover:bg-[#2c2c34] transition-colors border border-[#363640] cursor-pointer"
        >
          Complete Profile
        </button>
      </div>
      ...
      <div className="bg-[#1d1d22] rounded-2xl border border-[#2f2f36] p-5 shadow-[0_8px_24px_rgba(0,0,0,0.25)]">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-[11px] px-2 py-1 rounded bg-[#24242b] text-zinc-300 border border-[#34343e]">
            {upcomingDrive.date}
          </span>
        </div>
        ...
        <button
          ...
          className="w-full mt-4 py-2.5 rounded-lg bg-[#f7b545] text-[#1a1a1f] text-sm font-semibold border-none cursor-pointer hover:bg-[#f9c46c]"
        >
          View Drive
        </button>
      </div>
        ...
        <div className="space-y-3">
          {applications.map((app, idx) => (
            <div key={idx} className="flex justify-between items-center text-sm border-b border-[#2a2a31] pb-2 last:border-0 last:pb-0">
              ...
              <span className={`px-2 py-1 rounded text-xs font-medium border ${app.tone}`}>{app.status}</span>
            </div>
          ))}
        </div>
        <button
