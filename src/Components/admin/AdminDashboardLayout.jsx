...
function AdminDashboardLayout() {
  ...
  const navItems = [
    ...
    { name: 'Authorized Emails', path: '/admin/dashboard/authorized-emails', icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="h-full px-3 py-4 overflow-y-auto flex flex-col">
          ...
          <div className="flex items-center mb-8 px-3">
            ...
            <div>
              ...
              <p className="text-purple-200 text-xs">Placement System</p>
            </div>
          </div>
          ...
          <div className="pt-4 mt-4 border-t border-purple-700">
            <div className="px-3 py-2 mb-2">
              ...
              <p className="text-white font-medium text-sm truncate">{user?.fullName || 'Admin'}</p>
              <p className="text-purple-200 text-xs truncate">{user?.email}</p>
            </div>
            <button
              onClick={handleLogout}
              className="w-full flex items-center px-3 py-3 rounded-lg text-sm font-medium text-purple-100 hover:bg-red-600 hover:text-white transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
